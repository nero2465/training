...
function seedBuiltinExercises() {
  ...
  const updateMeta = db.prepare(`
    UPDATE exercises SET category=@category, secondary_muscles=@secondary_muscles, equipment=@equipment, frequency_note=@frequency_note
    WHERE name=@name AND category IS NULL
  `);

  const catalog = [
    { name:'Langhantel-Kniebeuge', muscle_groups:'Quadrizeps, Gesäß', technique_tip:'Füße schulterbreit, Rumpf fest, Knie folgen Fußspitzen, kontrolliert absenken.', category:'Beine', secondary_muscles:'Beinbeuger, Rückenstrecker, Bauch/Rumpf', equipment:'Langhantel, Rack', frequency_note:'1-2x/Woche, 48-72h' },
    ...
    { name:'Langhantel-Hip-Thrust', muscle_groups:'Gesäß', technique_tip:'Schulterblätter an Bank, Füße stabil, Becken hochdrücken.', category:'Hintere Kette', secondary_muscles:'Beinbeuger, Quadrizeps, Bauch/Rumpf', equipment:'Langhantel, Bank', frequency_note:'1-2x/Woche, 48h' },
    ...
    { name:'Leg Curl am Bank-Anbau', muscle_groups:'Beinbeuger', technique_tip:'Kontrolliert ausführen, oben anspannen, langsam ablassen.', category:'Hintere Kette', secondary_muscles:'Waden', equipment:'Hantelbank mit Leg-Curl-Anbau', frequency_note:'1-2x/Woche, 48h' },
    ...
    { name:'Langhantel-Bankdrücken', muscle_groups:'Brust', technique_tip:'Schulterblätter zurück und unten, Hantel zur unteren Brust führen.', category:'Brust', secondary_muscles:'Trizeps, vordere Schulter, oberer Rücken', equipment:'Hantelbank, Langhantel', frequency_note:'1-2x/Woche, 48-72h' },
    ...
    { name:'Langhantelrudern vorgebeugt', muscle_groups:'Latissimus, mittlerer Rücken', technique_tip:'Oberkörper stabil vorgeneigt, Rücken neutral, Hantel zur Brust.', category:'Rücken', secondary_muscles:'hintere Schulter, Bizeps, Rückenstrecker', equipment:'Langhantel', frequency_note:'1-2x/Woche, 48-72h' },
    { name:'Einarmiges Kurzhantelrudern auf der Bank', muscle_groups:'Latissimus, mittlerer Rücken', technique_tip:'Eine Hand/Knie abstützen, Rücken ruhig, Ellbogen zur Hüfte.', category:'Rücken', secondary_muscles:'hintere Schulter, Bizeps', equipment:'Hantelbank, Kurzhantel', frequency_note:'1-2x/Woche, 48h' },
    ...
    { name:'Schulterdrücken stehend mit Langhantel', muscle_groups:'Schultern', technique_tip:'Gesäß und Bauch fest, Hantel nah am Gesicht nach oben.', category:'Schultern', secondary_muscles:'Trizeps, oberer Rücken, Bauch/Rumpf', equipment:'Langhantel, Rack', frequency_note:'1-2x/Woche, 48-72h' },
    ...
    { name:'Seitheben mit Kurzhanteln', muscle_groups:'seitliche Schulter', technique_tip:'Leicht gebeugte Ellbogen, bis Schulterhöhe, kein Schwung.', category:'Schultern', secondary_muscles:'Trapez', equipment:'leichte Kurzhanteln', frequency_note:'1-3x/Woche, 24-48h' },
    ...
    { name:'SZ-Curl', muscle_groups:'Bizeps', technique_tip:'Ellbogen ruhig, kein Schwung, langsam ablassen.', category:'Arme', secondary_muscles:'Brachialis, Unterarme', equipment:'SZ-Stange', frequency_note:'1-2x/Woche, 48h' },
    ...
    { name:'SZ-French-Press liegend', muscle_groups:'Trizeps', technique_tip:'Oberarme ruhig, Stange zur Stirn senken, Ellbogen nicht ausstellen.', category:'Arme', secondary_muscles:'vordere Schulter, Brust', equipment:'SZ-Stange, Hantelbank', frequency_note:'1-2x/Woche, 48h' },
    ...
    { name:'Stehendes Wadenheben mit Langhantel', muscle_groups:'Waden', technique_tip:'Fersen kontrolliert absenken, hochdrücken, kurz halten.', category:'Waden', secondary_muscles:'Fußstabilisatoren', equipment:'Langhantel, Rack', frequency_note:'2-3x/Woche, 24-48h' },
